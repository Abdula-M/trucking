    ...
    <div className="bg-[#f3fffd] lg:min-h-[1000px] lg:pb-[300px] md:pb-[200px] pb-[220px]">
        <div className="bg-[url('/bg_truck.png')] bg-cover bg-center  h-screen relative">
            ...
            <div className="flex flex-col items-center justify-center h-screen pb-[200px]">
                <h1 className="md:text-[55px] xl:text-[70px] lg:text-[55px] text-[40px] text-white text-center lg:w-[800px] md:w-[550px] w-[350px] mx-auto font-montserrat font-extrabold xl:leading-[100px] lg:leading-[90px]">Asian Caravan</h1>
                <h2 className="md:text-[40px] xl:text-[60px] lg:text-[45px] text-[25px] text-white text-center lg:w-[800px] md:w-[550px] w-[350px] mx-auto font-montserrat font-extrabold md:leading-[50px] xl:leading-[80px] lg:leading-[50px]">{t('title')}</h2>
                <div className="xl:text-[30px] lg:text-[25px] md:text-[23px]  text-[18px] text-white text-center xl:w-[800px] lg:w-[600px] md:w-[550px] w-[360px] mx-auto md:mt-[40px] mt-[20px] font-medium ">{t('subtitle')}</div>
            </div>
        </div>
